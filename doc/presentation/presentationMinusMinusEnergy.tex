...
\logo{ \begin{minipage}{10.2cm}\includegraphics[height=1.5cm]{BETH.png}\end{minipage} \begin{minipage}{2.5cm}\includegraphics[height=1.2cm]{swissenergy.png}\end{minipage}}
