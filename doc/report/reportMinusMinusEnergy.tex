...
step 1 from figure \ref{img_impl} on page \pageref{img_impl}
...
step 5 from figure \ref{img_impl} on page \pageref{img_impl}
...
step 6 from figure \ref{img_impl} on page \pageref{img_impl}
