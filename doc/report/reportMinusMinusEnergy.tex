...
For the BETH-Event, we created individual modules, each will be discussed later. A short overview is presented in the following graphic.\\

\includegraphics[width=20cm]{../presentation/concept.png}\\

\subsubsection{Smart Contracts}
\color{red} TODO: Philip? \color{black}

\includegraphics[width=15cm]{../presentation/implementation.png}\\
